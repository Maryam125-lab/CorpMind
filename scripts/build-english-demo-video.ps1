...
$dir = "C:\Users\HP\Documents\CorpMind\docs\demo-video-english"
$scenes = @(
  @{ Image = "scene01-overview.png"; Audio = "scene01.wav"; Segment = "segment01.mp4" },
  @{ Image = "scene02-documents.png"; Audio = "scene02.wav"; Segment = "segment02.mp4" },
  @{ Image = "scene03-document-intelligence.png"; Audio = "scene03.wav"; Segment = "segment03.mp4" },
  @{ Image = "scene04-rag-question.png"; Audio = "scene04.wav"; Segment = "segment04.mp4" },
  @{ Image = "scene05-answer-citations.png"; Audio = "scene05.wav"; Segment = "segment05.mp4" },
  @{ Image = "scene06-activity.png"; Audio = "scene06.wav"; Segment = "segment06.mp4" }
)
...
$output = Join-Path $dir "corpmind-english-portfolio-demo.mp4"
& ffmpeg -y `
  -f concat `
  -safe 0 `
  -i $concatPath `
